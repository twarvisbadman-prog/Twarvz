...
class Note(db.Model):
    ...
    category = db.Column(db.String(50), nullable=False)  # 'note' or 'pastpaper'
...
# ============================================================
#  HTML TEMPLATE - STUDY HUB DESIGN
# ============================================================
STUDY_HUB_HTML = '''
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="glass-overlay">
        ...
        <div class="footer">
            <p>⚡ Study Hub — powered by TWARVIS · Free Educational Resource Hub</p>
        </div>
    </div>
