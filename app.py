...
# ============================================================
#  DATABASE CONFIGURATION - WORKS WITH INFINITYFREE
# ============================================================
...
# Remove port from host to avoid parsing issues
...
# ============================================================
#  YOUR ORIGINAL HTML - TWARVIS | MATRIX
# ============================================================
TWARVIS_HTML = '''
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        ...
        <div id="notesSection">
            <div class="resource-grid" id="notesGrid">
                <div class="loading"><i class="fas fa-spinner fa-spin"></i> Loading notes...</div>
            </div>
        </div>

        <div id="papersSection" style="display: none;">
            <div class="resource-grid" id="papersGrid">
                <div class="loading"><i class="fas fa-spinner fa-spin"></i> Loading past papers...</div>
            </div>
        </div>
    ...
    <div id="uploadModal" class="modal">
        <div class="modal-content">
            ...
            <form id="uploadForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title" id="resourceTitle" placeholder="e.g., Calculus II Final Exam Notes" required>
                </div>
                <div class="form-group">
                    <label>Description (optional)</label>
                    <textarea name="description" id="resourceDesc" rows="3" placeholder="Brief description of this resource..."></textarea>
                </div>
                <div class="form-group">
                    <label>PDF/DOC/DOCX File (Max 50MB)</label>
                    <input type="file" name="file" id="resourceFile" accept=".pdf,.doc,.docx" required>
                </div>
...
@app.route('/')
def index():
    return render_template_string(TWARVIS_HTML)
