...
# ============================================================
# Use a clean database URL without port in the host
...
# If Render provides a DATABASE_URL, fix it
if os.environ.get('DATABASE_URL'):
    ...
    if ':3306/' in database_url:
        database_url = database_url.replace(':3306/', '/?port=3306&')
    # Fix any double ? or &
    database_url = database_url.replace('?port=3306&?', '?').replace('&&', '&')
